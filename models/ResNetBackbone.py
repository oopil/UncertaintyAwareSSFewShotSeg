...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, zero_init_residual=False,groups=1,
        ...
        if replace_stride_with_dilation is None:
            ...
            replace_stride_with_dilation = [False, 2, 2]#[False, False, 2] #[False, 2, 2]
...
def resnet101(cfg=None, **kwargs):
    ...
    init_path = './FewShotSeg-dataset/cache/resnet101-63fe2227.pth'
    print(f'load: {init_path}')
